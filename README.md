...
### aM-Uninstall
```css
curl -s https://raw.githubusercontent.com/learnbyseven/amTraining/main/exercises/1-am-install/2-am-uninstall/uninstall_Aspenmesh.sh | bash
```
...
```css
curl -s https://raw.githubusercontent.com/learnbyseven/amTraining/main/exercises/1-am-install/4-am-all-components-uninstall/uninstall_Aspenmesh_all.sh | bash
```
### Traffic-Management 
